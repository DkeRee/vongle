...
InputSlotDialogMorph.prototype.specialOptionsMenu = function () {
    ...
    addSpecialOptions('messages', 'Â§_messagesMenu');
    addSpecialOptions('objects', 'Â§_objectsMenu');
    // addSpecialOptions('data types', 'Â§_typesMenu');
    addSpecialOptions('costumes', 'Â§_costumesMenu');
    addSpecialOptions('sounds', 'Â§_soundsMenu');
    addSpecialOptions('variables', 'Â§_getVarNamesDict');
    addSpecialOptions('piano keyboard', 'Â§_pianoKeyboardMenu');
    addSpecialOptions('360Â° dial', 'Â§_directionDialMenu');
    return menu;
};
